  ...
  render () {
    return (
      <section className="about">
        ...
        <p className="aboutDescription"> Have you ever placed an order for lunch or dinner and suddenly the server brings out the entree of the neighboring table and you instantly second guess your decision? You, my friend, have become a victim of ORDER ENVY. We are here to help! We proudly showcase the world renowned restaurants of The Pearl Brewery in San Antonio, Texas to give you the ability to preview how a specific entree will look, search for the best places that cater to dietary restrictions, as well as the opportunity to browse through the entree selections to familarize yourself with all of the culinary creations of the hottest chefs in San Antonio before you step foot inside the restaurant! Check out the Pearl restaurants below and rememeber... Dont get mad. Get ORDER ENVY. </p>
