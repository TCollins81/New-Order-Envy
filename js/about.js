  ...
  render () {
    return (
      <section className="about">
        ...
        <p className="aboutDescription">  We proudly showcase the world renowned restaurants of The Pearl Brewery in San Antonio, Texas to give you the ability to preview how an entree will look before you order, search for the best places that cater to dietary restrictions, as well as the opportunity to browse through the entree selections to familarize yourself with the culinary creations of the hottest chefs in San Antonio, before you step foot inside the restaurant! So the next time you place an order and the server brings out the entree of the neighboring table and you instantly second guess your decision just remember... Dont get mad. Get ORDER ENVY. Check out our featured Pearl Brewery restaurants below!  </p>
